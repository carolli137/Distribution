...
<div class="banner">
  <div class="user-box">
    ...
    <div class="user-joinin">
      ...
      <div class="bottom"><a href="<?php if(!($output['store_zizhi'])){?><?php echo urlShop('store_joinin', 'step0');?><?php }else { ?><?php echo urlShop('store_joininc', 'step0');?><?php } ?>" target="_blank">我要入驻</a><a href="<?php if(!($output['store_zizhi'])){?><?php echo urlShop('store_joinin', 'step0');?><?php }else { ?><?php echo urlShop('store_joininc', 'index');?><?php } ?>" target="_blank">查看入驻进度</a></div>
    </div>
     <?php }else { ?>
