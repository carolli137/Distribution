    ...
    <div id="saleRefundReturn">
      ...
      <div class="ncsc-form-default">
        ...
        <dl>
          ...
          <dd> <?php echo $output['express_e_name'].' , '.$output['return']['invoice_no']; ?> </dd>
        </dl>
        <?php } ?>
...
$(function(){
	$.getJSON('index.php?act=seller_center&op=get_express&e_code=<?php echo $output['express_e_code'];?>&shipping_code=<?php echo $output['return']['invoice_no'];?>&t=<?php echo random(7);?>',function(data){
		if(data){
